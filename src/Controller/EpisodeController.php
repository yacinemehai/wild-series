...
class EpisodeController extends AbstractController
{
    ...
    /**
     * @Route("/{id}", methods={"GET"},  name="episode_show")
     * @ParamConverter("episode", class="App\Entity\Program", options={"mapping": {"episode":"slug"}})
     * @return Response
     */
    ...
    /**
     * @Route("/{id}/edit", methods={"GET"},  name="episode_edit")
     * @ParamConverter("episode", class="App\Entity\Program", options={"mapping": {"episode":"slug"}})
     * @return Response
     */
